...
namespace Tests
{
    public class CustomerTests
    {
        ...
        {
            customer.AddRental(new Rental(new MovieNewRelease("show1"), 1));
        ...
        {
            customer.AddRental(new Rental(new MovieNewRelease("show1"), 2));
        ...
        {
            customer.AddRental(new Rental(new MovieNewRelease("show1"), 3));
        ...
        {
            customer.AddRental(new Rental(new MovieRegular("show1"), 1));
        ...
        {
            customer.AddRental(new Rental(new MovieRegular("show1"), 2));
            AssertStatement("show1", 2.0f, 2.0f, 1);
        }
        ...
        {
            customer.AddRental(new Rental(new MovieRegular("show1"), 3));
        ...
        {
            customer.AddRental(new Rental(new MovieChildren("show1"), 1));
        ...
        {
            customer.AddRental(new Rental(new MovieChildren("show1"), 3));
            AssertStatement("show1", 1.5f, 1.5f, 1);
        }
        ...
        {
            customer.AddRental(new Rental(new MovieChildren("show1"), 4));
        ...
        {
            customer.AddRental(new Rental(new MovieNewRelease("show1"), 3));
            customer.AddRental(new Rental(new MovieNewRelease("show2"), 3));
        ...
        {
            customer.AddRental(new Rental(new MovieRegular("show1"), 3));
            customer.AddRental(new Rental(new MovieRegular("show2"), 3));
        ...
        {
            customer.AddRental(new Rental(new MovieChildren("show1"), 4));
            customer.AddRental(new Rental(new MovieChildren("show2"), 4));
        ...
        {
            customer.AddRental(new Rental(new MovieNewRelease("show1"), 4));
            customer.AddRental(new Rental(new MovieRegular("show2"), 4));
            customer.AddRental(new Rental(new MovieChildren("show3"), 4));
