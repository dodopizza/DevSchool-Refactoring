...
namespace Tests
{
    ...
    public class CustomerTests
    {
        ...
        {
            customer.AddRental(new Rental(new NewMovie("show1"), 1));
        ...
        {
            customer.AddRental(new Rental(new NewMovie("show1"), 2));
        ...
        {
            customer.AddRental(new Rental(new NewMovie("show1"), 3));
        ...
        {
            customer.AddRental(new Rental(new NewMovie("show1"), 3));
            customer.AddRental(new Rental(new NewMovie("show2"), 3));
        ...
        {
            customer.AddRental(new Rental(new NewMovie("show1"), 4));
